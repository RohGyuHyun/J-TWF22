...
public:
	...
	int m_SaveType;
	afx_msg void OnBnClickedLoad2img();
	afx_msg void OnBnClickedSel2wnd();
	afx_msg void OnBnClickedOvlout();
	afx_msg void OnBnClickedUnselwnd();
	afx_msg void OnBnClickedAddintrect();
	afx_msg void OnBnClickedBtnGetovldc();
	afx_msg void OnBnClickedChkpanzoom();
};
