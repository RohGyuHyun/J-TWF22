...
#define	WM_JOGBTN_LBUTTONDOWN	(1000)
#define WM_JOGBTN_LBUTTONUP		(1001)
#define WM_JOGBTN_RBUTTONDOWN	(1002)


#include "UniUtilBase.h"

class DLLDECL CButtonST : public CButton
{
public:
    CButtonST();
	~CButtonST();
...
protected:
	...
	BOOL		m_bIsRadio;			// Is the button a checkbox?
