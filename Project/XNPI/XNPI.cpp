...
BEGIN_MESSAGE_MAP(CXNPIApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CXNPIApp::OnAppAbout)
...
BOOL CXNPIApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CXNPIDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CXNPIView));
	if (!pDocTemplate)
		return FALSE;
...
void CXNPIApp::OnClosingMainFrame(CFrameImpl* pFrameImpl)
{
