...
int CCompo::LoadParam(CXmlNode* pNode)//, BOOL bUseCurNode)
{
	...
	m_pCompoTracker->m_rectBuffer.left = (LONG)(pNode->ReadDouble(0.0, _T("ImageLeft")));
	m_pCompoTracker->m_rectBuffer.right = (LONG)(pNode->ReadDouble(0.0, _T("ImageRight")));
	m_pCompoTracker->m_rectBuffer.top = (LONG)(pNode->ReadDouble(0.0, _T("ImageTop")));
	m_pCompoTracker->m_rectBuffer.bottom = (LONG)(pNode->ReadDouble(0.0, _T("ImageBottom")));

	m_pCompoTracker->m_rect.left = (LONG)(pNode->ReadDouble(0.0, _T("BandLeft")));
	m_pCompoTracker->m_rect.right = (LONG)(pNode->ReadDouble(0.0, _T("BandRight")));
	m_pCompoTracker->m_rect.top = (LONG)(pNode->ReadDouble(0.0, _T("BandTop")));
	m_pCompoTracker->m_rect.bottom = (LONG)(pNode->ReadDouble(0.0, _T("BandBottom")));
