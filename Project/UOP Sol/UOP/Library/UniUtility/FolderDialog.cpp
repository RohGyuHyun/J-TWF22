...
//	m_bi.ulFlags = dwFlags | BIF_STATUSTEXT;
	m_bi.ulFlags = BIF_RETURNONLYFSDIRS | BIF_STATUSTEXT | BIF_VALIDATE;
	m_bi.lpfn = BrowseDirectoryCallback;
//	m_bi.lParam = (LPARAM)this;
	m_bi.lParam = (LPARAM)str.GetBuffer(str.GetLength());
	*/
}
...
int CFolderDialog::DoModal()
{
	...
	CString strPath = _T("D:\\Model9800");
	BROWSEINFO brInfo;
	...
	if(pidlBrowse != NULL)
	{
		...
		m_strFinalFolderName = szFolder;

		return IDOK;
	}
	else
	{
		m_strFinalFolderName = _T("NewModel");
