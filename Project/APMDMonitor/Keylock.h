...
#ifndef __MEGADEMO
// 메가락 라이브러리 외부 함수 선언 시작
#ifdef __cplusplus						
extern "C" {
#endif
	extern unsigned int  lock_init_usb(unsigned int op1);
	extern unsigned char lock_auto(unsigned char op1);
	...
	extern unsigned char lock_write(unsigned char op1, unsigned char op2);
	extern unsigned char lock_read(unsigned char op1, unsigned char op2);
#ifdef __cplusplus						
}
#endif
//  메가락 라이브러리 외부 함수 선언 끝
#endif
#ifdef __MEGADEMO
// 메가락 라이브러리 외부 함수 선언 시작
#ifdef __cplusplus						
