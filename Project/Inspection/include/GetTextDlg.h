...
public:
	...
	CGetTextDlg(int maxchar = 20, TCHAR* getnum = _T(""), TCHAR* title = _T("Input the Value."), CWnd* pParent = NULL,
			     BOOL pwd = FALSE, BOOL btndisable = FALSE);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CGetTextDlg)
	enum { IDD = IDD_DIALOG_TEXT_BOX };
	CBtnenhctrl	m_sDispValue;
	CBtnenhctrl	m_bDot;
	CBtnenhctrl	m_bEqual;
	CBtnenhctrl	m_bColon;
	CBtnenhctrl	m_bWon;
	//}}AFX_DATA
